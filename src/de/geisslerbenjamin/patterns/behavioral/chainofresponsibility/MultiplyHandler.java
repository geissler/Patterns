...
/**
 * Handler which tests if the request is a simple multiplication. If so, the sum is calculated otherwise the request is
 * forwarded to the next chain element.
 * Created by Benjamin on 22.12.13.
 */
public class MultiplyHandler extends AbstractHandler {
    @Override
